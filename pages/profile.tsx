...
import { IPlaylist, IVideoV3 } from "../interface";
    ...
    <Body>
      ...
      <div>
        ...
        <button
          ...
          className={`${videosList.length === 5 ? "hidden": "block"} bg-transparent border border-blue-500 px-4 py-2 mt-4 text-white uppercase font-semibold`}
        >
